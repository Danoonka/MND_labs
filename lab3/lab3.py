...
for i in range(3):
    if round(av_y[i], 5) == round(y_pr[i], 5):
        check1 = "Our values coincide with average values of response function due to rows"
    else:
        check1 = "Our values coincide with average values of response function due to rows"
...
if Gp < Gt:
    ...
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
    print('Error, please repeat the experiment')
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
...
if (Fp < Fisher_table[f4]):
    check3 = "The regression equation is adequate"
else:
    check3 = "The regression equation doesn't adequate"


print("\nThe regression equation: y = b0 + b1*x1 + b2*x2+ b3*x3\n")
...
print("\nDispersion:\n d1 =", round(S[0], 3), "\n d2 =", round(S[1], 3), \
      "\n d3 =", round(S[2], 3), "\n d4 =", round(S[3], 3))
print("Cochren's criterion: Gr = " + str(round(Gp, 3)))
print(check2)
